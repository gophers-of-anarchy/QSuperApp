...
func IsEducationalMiddleware(next echo.HandlerFunc) echo.HandlerFunc {
...
func AuthAndIsEducationalMiddleware(next echo.HandlerFunc) echo.HandlerFunc {
	return AuthMiddleware(IsEducationalMiddleware(next))
}
