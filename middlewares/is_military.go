...
func IsMilitaryMiddleware(next echo.HandlerFunc) echo.HandlerFunc {
...
func AuthAndIsMilitaryMiddleware(next echo.HandlerFunc) echo.HandlerFunc {
	return AuthMiddleware(IsMilitaryMiddleware(next))
}
